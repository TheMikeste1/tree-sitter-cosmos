  ...
  rules: {
    ...
    number: ($) =>
      choice(
        ...
        $._binary_number,
        // Other values from
        // <https://github.com/OpenC3/cosmos/blob/63d0fc07dc5d6e0922fd891e69f4b2768a94bd1d/openc3/lib/openc3/config/config_parser.rb#L338>
        "MAX",
        "MIN",
        "MIN_INT8",
        "MAX_INT8",
    ...
    modifier_meta: ($) =>
      seq(
        ...
        field("value", repeat(choice($.identifier, $.string))),
      ),
    ...
    item_definition: ($) =>
      seq(
        ...
        field("bit_offset", $.number),
        field("bit_size", $.number),
        choice($._number_item, $._string_item, $._block_item),
        optional($._description),
        optional(field("endianness", $.endianness)),
      ),
    append_item_definition: ($) =>
    ...
    _number_item: ($) => seq(field("data_type", $.number_dtype)),
    _string_item: (_) => seq(field("data_type", "STRING")),
    _block_item: (_) => seq(field("data_type", "BLOCK")),
